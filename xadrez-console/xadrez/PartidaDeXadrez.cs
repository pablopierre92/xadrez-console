...
namespace xadrez
{
    internal class PartidaDeXadrez
    {
        ...
        private HashSet<Peca> pecas; //conjunto de pecas, guarda as pecas
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if(p is Peao)
            {
                if(origem.coluna != destino.coluna && pecaCapturada == vulneravelEmPassant)
                {
                    ...
                    if (p.cor == Cor.Branca)
                    {
                        posP = new Posicao(3, destino.coluna); //linha 3
                    }
                    else
                    {
                        posP = new Posicao(4, destino.coluna); // linha 4
        ...
        private Peca rei(Cor cor)
        {
            ...
            {
                if (x is Rei)  // se a peça x é istância de Rei (testa se um determinado objeto é de uma subclasse)
                {
                    return x;
                }
            }
